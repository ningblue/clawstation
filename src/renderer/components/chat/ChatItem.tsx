...
const UserMessage: React.FC<{
  ...
  return (
    ...
    >
      <div className="max-w-[80%] rounded-2xl rounded-br-sm bg-primary px-3.5 text-primary-foreground">
...
const AssistantMessage: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[90%] rounded-2xl rounded-bl-sm bg-muted px-3.5">
